...
const inputStyle: CSSProperties = {
  ...
  font: "400 18px Caveat,cursive", color: '#3a3730', outline: 'none',
}

const btnStyle: CSSProperties = {
  width: '100%', padding: '9px 0', borderRadius: 8, border: 'none', cursor: 'pointer',
  background: '#7fa86a', color: '#fbf6e7', font: "400 15px 'Special Elite',monospace",
  letterSpacing: '1px',
}
  ...
  return (
    ...
    >
      <form style={cardStyle} onSubmit={submit}>
        <div style={{ font: "400 30px Caveat,cursive", color: '#3a3730' }}>The Dreaming Scallion</div>
        <div style={{ font: "400 13px 'Special Elite',monospace", color: 'rgba(58,55,48,0.6)', letterSpacing: '.5px' }}>
        ...
        />
        {error && (
          <div style={{ font: "400 13px 'Special Elite',monospace", color: '#b4553f' }}>
